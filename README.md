...
- [x] Review installed guix installed packages and consider whether to integrate them into the system config
- [ ] Fix audio drifting
...
reboot
```
8. Clone this and the home files repo, stow the conifg files, then update Guix:
```
git clone <this repo>
git clone <home files repo>
cd <home files repo>
stow . # This will symlink the channels and shell configs
guix pull
```
